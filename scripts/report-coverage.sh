...
java -cp ./codacy-coverage-reporter.jar com.codacy.CodacyCoverageReporter -l Java -r ./tools/smoke-tests/build/reports/jacoco/jacocoRootReport/jacocoRootReport.xml
# END of Codacy setup.
