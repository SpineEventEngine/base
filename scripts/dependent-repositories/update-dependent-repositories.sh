#!/bin/bash
#
# Update the base library dependency version in the multiple repositories.
#
...
function main() {
    ...
    chmod +x ./scripts/dependent-repositories/core-update-base-version.sh
    ./scripts/dependent-repositories/core-update-base-version.sh \
